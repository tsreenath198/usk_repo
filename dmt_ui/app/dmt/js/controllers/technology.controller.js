/*(function() {*/
    ...
    function init() {
        ...
        technologyService.getAllTechnologies().then(function(response) {
            ...
            $scope.technologiesOptions = [ 5, 10, 15 ];
        ...
        $scope.selectAll = function() {
            for ( var i in $scope.technologiesData) {
                ...
                $scope.selected.push($scope.technologiesData[i].id);
            }
            ;
        };
        ...
        $scope.deleteSelected = function(ev) {
            ...
            if ($scope.selected.length > 0) {
                ...
                $mdDialog.show(confirm).then(function() {
                    $scope.technologiesData = $scope.technologiesData.filter(function(obj) {
                        return $scope.selected.indexOf(obj.id) === -1;
                    });
                    $scope.technologiesLength = $scope.technologiesData.length;
                }, function() {
