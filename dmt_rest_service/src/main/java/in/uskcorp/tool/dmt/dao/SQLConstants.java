...
public class SQLConstants {
	...
	public static final String SUPPORT_INTERACTION_SELECT = "SELECT si.*, si.id as 'id',e.name as 'employee',tre.name as 'trainee' FROM support_interaction si,employee e,trainee tre WHERE si.lead_id = e.id AND tre.id = si.trainee_id";
